"""
Django settings for cold_glitter_dev_92408 project.
...
ROOT_URLCONF = 'cold_glitter_dev_92408.urls'
...
WSGI_APPLICATION = 'cold_glitter_dev_92408.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_glitter_dev_92408 API",
    "DESCRIPTION": "API documentation for cold_glitter_dev_92408 App",
    "VERSION": "v1",
}
